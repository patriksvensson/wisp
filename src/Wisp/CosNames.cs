...
public static class CosNames
{
    ...
    public static CosName CF { get; } = new("CF");
    ...
    public static CosName EncryptMetadata { get; } = new("EncryptMetadata");
    ...
    public static CosName O { get; } = new("O");
    public static CosName ObjStm { get; } = new("ObjStm");
    public static CosName P { get; } = new("P");
    ...
    public static CosName R { get; } = new("R");
    ...
    public static CosName SubFilter { get; } = new("SubFilter");
    ...
    public static CosName U { get; } = new("U");
    public static CosName V { get; } = new("V");
    public static CosName Version { get; } = new("Version");
